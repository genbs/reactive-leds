 ...
 */
export declare function sample(pixels: Pixels, pixelsSize: [
	number,
	number
], grid: Grid, polygon: Polygon, steps: number, wa?: WhiteChannel, output?: Uint8Array): Uint8Array;
...
export declare function connect(ip: IP, port?: number, deviceMapping?: DeviceMapping): Promise<Device | null>;
/** Connect every device in a mapping, dropping unreachable devices. */
export declare function mapping(config: Mapping): Promise<DeviceGroup>;
/**
