...
- `leds <target> <leds_package>` - send LED updates. The package is a comma-separated list of values in groups of 5: `<led_index>,<r>,<g>,<b>,<w>` (w = white/brightness). Multiple LEDs can be chained: `0,255,0,0,0,1,0,128,128,0`. Each value between 0 and 255.
